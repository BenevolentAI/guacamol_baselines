...
class FragGTGenerator:
    def __init__(self,
                 ...
                 candidate_population_size: int = 50,
                 generations: int = 500,
        ...
        Args:
            ...
            candidate_population_size: number of new molecules generated by applying mutation and crossover operators
    ...
    def optimize(self,
        ...
        mol_generator = MolecularPopulationGenerator(fragstore_path=self.fragstore_path,
                                                     ...
                                                     n_molecules=self.candidate_population_size,
        ...
        for generation in range(self.generations):
            ...
            # calculate stats
            gen_time = time() - t0
            mol_sec = (self.population_size + self.candidate_population_size) / gen_time
            t0 = time()
